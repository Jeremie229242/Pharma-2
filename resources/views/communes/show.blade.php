            ...
            <div class="px-6">
              ...
              <div class="text-center mt-12">
                ...
                <div class="mb-2 text-blueGray-600 mt-10">
                  ...
                  >Date de création : {{ $commune->created_at->format('d/m/Y H:i') }}
                </div>
                <div class="mb-2 text-blueGray-600">
                  <i
                    class="fas fa-university mr-2 text-lg text-blueGray-400"
                  ></i
                  >Dernière modification :   {{ $commune->updated_at->format('d/m/Y H:i') }}
                </div>
              </div>
              ...
              <div class="rounded-t  mb-0 px-6 py-6">
                  <div class="text-center flex justify-between">
                    <a  href="{{ route('communes.index') }}" class="text-blueGray-700 px-2 py-2 rounded-lg shadow hover:shadow-md outline-none focus:outline-none  bg-pink-500 text-xl font-bold">
                     Retour
                    </a>
                    <a
