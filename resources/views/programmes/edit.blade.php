...
<div class="px-4 md:px-10 mx-auto w-full -m-24">
    ...
    <div class="w-full lg:w-12/12 px-4">
        <div class="relative w-full mb-3">
            <label class="block uppercase text-blueGray-600 text-xs font-bold mb-2">Document</label>
    ...
    <p>📂 Fichier actuel :</p>
        ...
        <a href="{{ route('programmes.download', $programme) }}" class="btn btn-sm btn-primary" download>
...
<div class="flex flex-wrap">
                      <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3">
                          ...
                          >
                          Choisir un nouveau fichier (optionnel)
                          </label>
                          <input
                            type="file"
                            name="image_one"
